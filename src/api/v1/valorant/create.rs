...
impl api::ApiApplication {
    ...
    async fn insert_valorant_match_teams(&self, tx : &mut Transaction<'_, Postgres>, match_id: &str, team_data: &Vec<super::ValorantMatchTeamData>) -> Result<(), common::SquadOvError> {
        ...
        for (idx, m) in team_data.iter().enumerate() {
            sql.push(format!("(
                ...
                match_id=match_id,
                team_id=&m.team_id,
                won=common::sql_format_bool(m.won),
    ...
    async fn insert_valorant_match_players(&self, tx : &mut Transaction<'_, Postgres>, match_id: &str, player_data: &Vec<super::ValorantMatchPlayerData>) -> Result<(), common::SquadOvError> {
        let mut sql : Vec<String> = Vec::new();
        sql.push(String::from("
    ...
    async fn insert_valorant_match_kills(&self, tx : &mut Transaction<'_, Postgres>, match_id: &str, kill_data: &Vec<super::ValorantMatchKillData>) -> Result<(), common::SquadOvError> {
        let mut sql : Vec<String> = Vec::new();
        sql.push(String::from("
        ...
        for (idx, m) in kill_data.iter().enumerate() {
            sql.push(format!("(
                ...
                match_id=match_id,
                round_num=m.round,
                killer_puuid=common::sql_format_option_string(&m.killer),
    ...
    async fn insert_valorant_match_damage<'a>(&self, tx : &mut Transaction<'_, Postgres>, match_id: &str, damage: &super::ValorantAllPlayerDamageData<'a>) -> Result<(), common::SquadOvError> {
        let mut sql : Vec<String> = Vec::new();
        sql.push(String::from("
    ...
    async fn insert_valorant_match_round_player_stats<'a>(&self, tx : &mut Transaction<'_, Postgres>, match_id: &str, player_stats: &super::ValorantAllPlayerRoundStatsData<'a>) -> Result<(), common::SquadOvError> {
        let mut sql : Vec<String> = Vec::new();
        sql.push(String::from("
    ...
    async fn insert_valorant_match_round_player_economies<'a>(&self, tx : &mut Transaction<'_, Postgres>, match_id: &str, player_econs: &super::ValorantAllPlayerRoundEconomyData<'a>) -> Result<(), common::SquadOvError> {
        let mut sql : Vec<String> = Vec::new();
        sql.push(String::from("
    ...
    async fn insert_valorant_match_rounds(&self, tx : &mut Transaction<'_, Postgres>, match_id: &str, round_data: &Vec<super::ValorantMatchRoundData>) -> Result<(), common::SquadOvError> {
        ...
        for (idx, m) in round_data.iter().enumerate() {
            sql.push(format!("(
                ...
                plant_round_time=common::sql_format_option_value(&m.plant_round_time),
                planter_puuid=common::sql_format_option_string(&m.bomb_planter),
                defuse_round_time=common::sql_format_option_value(&m.defuse_round_time),
                defuser_puuid=common::sql_format_option_string(&m.bomb_defuser),
    ...
    async fn insert_valorant_raw_data(&self, tx : &mut Transaction<'_, Postgres>, match_id: &str, uuid: &Uuid, raw_data: &Option<String>) -> Result<(), common::SquadOvError> {
        match raw_data {
            Some(json) => {
    ...
    async fn insert_valorant_player_round_data(&self, tx : &mut Transaction<'_, Postgres>, data: &Vec<super::ValorantPlayerRoundMetadata>) -> Result<(), common::SquadOvError> {
        let mut sql : Vec<String> = Vec::new();
        sql.push(String::from("
    ...
    async fn insert_valorant_player_data(&self, tx : &mut Transaction<'_, Postgres>, player_data: &Option<super::ValorantPlayerMatchMetadata>) -> Result<(), common::SquadOvError> {
        match player_data {
            Some(data) => {
                tx.execute(
                    sqlx::query!(
    ...
    pub async fn insert_valorant_match(&self, tx : &mut Transaction<'_, Postgres>, uuid: &Uuid, raw_match : InputValorantMatch) -> Result<(), common::SquadOvError> {
