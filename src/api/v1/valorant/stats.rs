...
impl api::ApiApplication {
    async fn get_player_stats_summary(&self, puuid: &str) -> Result<Option<super::ValorantPlayerStatsSummary>, common::SquadOvError> {
        Ok(sqlx::query_as!(
...
pub async fn get_player_stats_summary_handler(data : web::Path<ValorantUserStatSummaryInput>, app : web::Data<Arc<api::ApiApplication>>) -> Result<HttpResponse, common::SquadOvError> {
