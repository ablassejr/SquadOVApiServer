...
impl api::ApiApplication {
    async fn get_valorant_match_metadata(&self, match_id: &str) -> Result<super::ValorantMatchMetadata, common::SquadOvError> {
        Ok(sqlx::query_as!(
    ...
    async fn get_valorant_match_teams(&self, match_id: &str) -> Result<Vec<super::ValorantMatchTeamData>, common::SquadOvError> {
        Ok(sqlx::query_as!(
    ...
    async fn get_valorant_match_players(&self, match_id: &str) -> Result<Vec<super::ValorantMatchPlayerData>, common::SquadOvError> {
        Ok(sqlx::query_as!(
    ...
    async fn get_valorant_match_damage(&self, match_id: &str) -> Result<Vec<RawValorantMatchDamage>, common::SquadOvError> {
        Ok(sqlx::query_as!(
    ...
    async fn get_valorant_match_round_player_loadouts(&self, match_id: &str) -> Result<Vec<RawValorantRoundPlayerLoadout>, common::SquadOvError> {
        Ok(sqlx::query_as!(
    ...
    async fn get_valorant_match_round_player_stats(&self, match_id: &str) -> Result<Vec<RawValorantRoundPlayerStats>, common::SquadOvError> {
        Ok(sqlx::query_as!(
    ...
    async fn get_valorant_match_rounds(&self, match_id: &str) -> Result<Vec<super::ValorantMatchRoundData>, common::SquadOvError> {
    ...
    async fn get_valorant_match_kills(&self, match_id: &str) -> Result<Vec<super::ValorantMatchKillData>, common::SquadOvError> {
        Ok(sqlx::query_as!(
    ...
    async fn get_valorant_match_details(&self, match_id: &str) -> Result<super::FullValorantMatchData, common::SquadOvError> {
        ...
        match_data.match_uuid = match self.check_if_valorant_match_exists(match_id).await? {
            Some(x) => x.uuid,
            None => return Err(common::SquadOvError::NotFound)
        };
    ...
    async fn get_valorant_player_match_metadata(&self, match_id: &str, puuid: &str)  -> Result<Option<super::ValorantPlayerMatchMetadata>, common::SquadOvError> {
        match sqlx::query_as!(
...
pub async fn get_valorant_match_details_handler(data : web::Path<GetValorantMatchDetailsInput>, app : web::Data<Arc<api::ApiApplication>>) -> Result<HttpResponse, common::SquadOvError> {
    let match_data = app.get_valorant_match_details(&data.match_id).await?;
    Ok(HttpResponse::Ok().json(&match_data))
}

pub async fn get_valorant_player_match_metadata_handler(data: web::Path<GetValorantPlayerMatchMetadataInput>, app : web::Data<Arc<api::ApiApplication>>) -> Result<HttpResponse, common::SquadOvError> {
