...
pub async fn find_vod_from_match_user_handler(data : web::Path<VodMatchFindFromMatchUser>, app : web::Data<Arc<api::ApiApplication>>) -> Result<HttpResponse, common::SquadOvError> {
