...
pub async fn get_user_profile_handler(data : web::Path<ProfileResource>, app : web::Data<Arc<api::ApiApplication>>) -> Result<HttpResponse, common::SquadOvError> {
...
pub async fn get_current_user_profile_handler(app : web::Data<Arc<api::ApiApplication>>, request : HttpRequest) -> Result<HttpResponse, common::SquadOvError> {
