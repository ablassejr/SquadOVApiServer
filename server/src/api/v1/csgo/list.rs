...
pub async fn list_csgo_matches_for_user_handler(app : web::Data<Arc<api::ApiApplication>>, path: web::Path<CsgoUserMatchListInput>, query: web::Query<api::PaginationParameters>, req: HttpRequest) -> Result<HttpResponse, SquadOvError> {
