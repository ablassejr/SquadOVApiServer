...
pub async fn get_riot_summoner_account_handler(app : web::Data<Arc<api::ApiApplication>>, path: web::Path<RiotSummonerPathInput>) -> Result<HttpResponse, SquadOvError> {
    Ok(HttpResponse::Ok().finish())
}